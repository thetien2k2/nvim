...
map("n", "<leader>cd", "<cmd> cd %:p:h <cr>", { desc = "cd to current file" })
...
map("n", "<leader>fz", "<cmd>Telescope current_buffer_fuzzy_find<CR>", { desc = "in current buffer" })
map("n", "<leader>ft", "<cmd>Telescope terms<CR>", { desc = "pick hidden term" })
map("n", "<leader>fs", "<cmd>Telescope themes<CR>", { desc = "nvchad themes" })
...
map("n", "<leader>gt", "<cmd>Telescope git_stash<CR>", { desc = "stash" })
map("n", "<leader>gf", "<cmd>Telescope git_bcommits<CR>", { desc = "buffer's commits" })
map("v", "<leader>gr", "<cmd>Telescope git_bcommits_range<CR>", { desc = "buffer's range commits" })
-- map("n", "<leader>gh", require("gitsigns").reset_hunk, opts "Reset Hunk")
-- map("n", "<leader>gp", require("gitsigns").preview_hunk, opts "Preview Hunk")
-- map("n", "<leader>gl", require("gitsigns").blame_line, opts "Blame Line")
